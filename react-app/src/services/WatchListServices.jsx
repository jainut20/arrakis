...
const addToWatchList = (securityid,userid)=>{
    ...
    return axios.post(`${baseURL}/watchlist/add`,{"securityid":securityid,"userid":userid})
}

const removeFromWatchList = (securityid,userid)=>{
    // returns "OK" if successful
    return axios.post(`${baseURL}/watchlist/remove`,{"securityid":securityid,"userid":userid});
}
