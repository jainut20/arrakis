...
INSERT INTO SECURITY (id,isin,cusip,issuer,maturitydate,coupon,type,facevalue,status) VALUES
                     (2,'DY2TYT12','23EDJHH','DB','2020-12-01','ABC','PVT',2000,'INACTIVE');


INSERT INTO SECURITY (id,isin,cusip,issuer,maturitydate,coupon,type,facevalue,status) VALUES
                     (3,'DY2TYT12','23EDJHH','CREDIT','2023-08-01','ABC','PVT',3500.2,'ACTIVE');

INSERT INTO SECURITY (id,isin,cusip,issuer,maturitydate,coupon,type,facevalue,status) VALUES
                     (4,'DFHJH342','23EDJHH','RIL','2024-02-03','ABC','GOVT',5421.2,'ACTIVE');
